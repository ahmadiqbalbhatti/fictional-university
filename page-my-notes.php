...
while ( have_posts() ) {
	...
	<div class="container container--narrow page-section">
		...
		<div class="create-note">
			...
			<span class="note-limit-message">Note Limit Reached: Delete an existing note to
				make room for a new one.</span>
		</div>
		...
		<ul class="min-list link-list" id="my-notes">
			...
			while ( $userNotes->have_posts() ) {
				...
				<li data-id="<?php the_ID(); ?>">
					...
					<textarea readonly
					          class="note-body-field"><?php echo esc_attr( wp_strip_all_tags
